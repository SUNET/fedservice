...
class TestServer():
    ...
    def create_federation(self):
        ...
        # Slightly more complex chain setup leaf->intermediate->trust anchor 2->trust anchor 1

    def test_sequence_of_trust_anchors(self):
        _federation_entity = self.leaf

        _msgs = create_trust_chain_messages(self.leaf, self.intermediate, self.ta2, self.ta1)
